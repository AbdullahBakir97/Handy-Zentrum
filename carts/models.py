...
class Cart(models.Model):
    ...
    class Meta:
        ...
        ordering = ['-created_at']
        constraints = [
            models.CheckConstraint(check=models.Q(total_quantity__gte=0), name='cart_quantity_non_negative')
        ]
    ...
    def clear_expired_carts():
        ...
        expired_carts = Cart.objects.filter(updated_at__lt=expiration_date, is_active=True)
