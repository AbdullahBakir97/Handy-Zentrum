...
class ProductService:
    ...
    def __init__(self, base_sku_generator: BaseSKUGenerator, variant_sku_generator: VariantSKUGenerator, validation: ProductValidation):
        """
    ...
    def create_product(self, product_data, variant_data_list):
        ...
        if variant_data_list:
            ...
            for variant_data in variant_data_list:
                ...
                variant_sku = self.variant_sku_generator.generate_sku(product, variant_data)
