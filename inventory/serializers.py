...
class InventoryItemSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = InventoryItem
        fields = ['id', 'product', 'product_name', 'quantity', 'location', 'location_name', 'status', 'last_updated']
...
class StockAdjustmentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'inventory_item', 'inventory_item_details', 'adjustment_type', 'quantity', 'reason', 'performed_by', 'created_at']
...
class InventoryTransferSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'product', 'product_name', 'from_location', 'from_location_name', 'to_location', 'to_location_name', 'quantity', 'initiated_by', 'created_at', 'status']