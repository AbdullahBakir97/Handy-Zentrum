...
class SalesByProduct(models.Model):
    ...
    class Meta:
        ...
        constraints = [
            models.CheckConstraint(check=models.Q(total_units_sold__gte=0), name='total_units_non_negative'),
            models.CheckConstraint(check=models.Q(total_revenue__gte=0), name='total_revenue_non_negative'),
        ]
...
class SalesByCustomerSegment(models.Model):
    ...
    class Meta:
        ...
        ordering = ['segment']
        constraints = [
            models.CheckConstraint(check=models.Q(total_sales__gte=0), name='total_sales_non_negative'),
            models.CheckConstraint(check=models.Q(total_orders__gte=0), name='total_orders_non_negative'),
        ]
