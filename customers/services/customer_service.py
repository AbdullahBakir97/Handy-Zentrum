...
class CustomerService:
    @staticmethod
    def create_customer(first_name, last_name, email, phone_number, is_loyalty_member=False):
        ...
        customer = Customer.objects.create(user=user, first_name=first_name, last_name=last_name, 
                                           email=email, phone_number=phone_number, is_loyalty_member=is_loyalty_member)
        return customer
    ...
    def add_interaction(customer, interaction_type, notes):
        ...
        return CustomerInteraction.objects.create(customer=customer, interaction_type=interaction_type, notes=notes)
