...
from .utils import calculate_loyalty_tier
...
def sync_customer_with_user(sender, instance, **kwargs):
    ...
    try:
        ...
        if customer.first_name != instance.first_name or customer.last_name != instance.last_name or customer.email != instance.email:
